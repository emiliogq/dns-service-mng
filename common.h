...
// It has each IP and its white space.
#define MAX_IPS 50

#define DEFAULT_PORT 8604
...
void sendOpCodeError(int sock, short errorCode);

/**
*
**/
void printDataReceived(int op_code, char *buffer);
